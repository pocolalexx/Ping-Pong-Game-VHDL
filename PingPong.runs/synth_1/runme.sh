...
HD_PWD='C:/Users/Pocol/OneDrive - Technical University of Cluj-Napoca/Desktop/Proiect SCID/PingPong/PingPong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PingPongGame.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PingPongGame.tcl
