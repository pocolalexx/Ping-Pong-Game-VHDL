...
HD_PWD='C:/Users/Pocol/OneDrive - Technical University of Cluj-Napoca/Desktop/Proiect SCID/PingPong/PingPong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PingPongGame.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PingPongGame.tcl -notrace
